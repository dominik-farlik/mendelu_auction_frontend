            ...
            {!isAuthPage && (
                <>
                    ...
                    <div className={`
                        ...
                        md:static md:w-auto md:bg-transparent md:border-none md:px-10 md:py-0 md:flex-row md:gap-8 md:items-center md:shadow-none md:translate-y-0 md:opacity-100 md:scale-100 ${desktopTextClass}
